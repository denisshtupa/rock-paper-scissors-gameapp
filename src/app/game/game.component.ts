...
export class GameComponent {
  ...
  public resetPlayerGame(): void {
    ...
    this.playerGamesHistory.push(result);
    console.log("his.playerGamesHistory", this.playerGamesHistory)
    this.scores = [0, 0];
  ...
  public resetComputerGame(): void {
    ...
    this.computerGamesHistory.push(result);
    console.log("his.computerGamesHistory", this.computerGamesHistory)
